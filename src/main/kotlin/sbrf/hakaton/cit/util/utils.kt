...
fun getProp(propKey: String, default: Any) = Util.propMap[propKey] ?: default.toString()

fun getProp(envKey: String, propKey: String, default: Any) =
    System.getenv(envKey) ?: Util.propMap[propKey] ?: default.toString()
